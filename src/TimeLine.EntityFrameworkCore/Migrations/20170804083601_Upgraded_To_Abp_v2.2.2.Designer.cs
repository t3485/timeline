...
namespace TimeLine.Migrations
{
    ...
    partial class Upgraded_To_Abp_v222
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("TimeLine.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("TimeLine.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("TimeLine.Authorization.Roles.Role", b =>
                {
                    b.HasOne("TimeLine.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("TimeLine.Authorization.Users.User", "DeleterUser")
                        .WithMany()
